...
r_asm_version.restype = POINTER_T(ctypes.c_char)
...
R_ASM_SYNTAX_JZ = 5
c__Ea_R_ASM_SYNTAX_NONE = ctypes.c_int # enum
...
c__Ea_R_ASM_MOD_RAWVALUE = ctypes.c_int # enum
...
class struct_r_asm_code_t(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('len', ctypes.c_int32),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('bytes', POINTER_T(ctypes.c_ubyte)),
    ('assembly', POINTER_T(ctypes.c_char)),
    ('equs', POINTER_T(struct_r_list_t)),
...
class struct_c__SA_RAsmEqu(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
...
RAsm = struct_r_asm_t
RAsmModifyCallback = POINTER_T(ctypes.CFUNCTYPE(ctypes.c_bool, POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_ubyte), ctypes.c_int32, ctypes.c_uint64))
RAsmPlugin = struct_r_asm_plugin_t
r_asm_new = _libr_asm.r_asm_new
r_asm_new.restype = POINTER_T(struct_r_asm_t)
r_asm_new.argtypes = []
r_asm_free = _libr_asm.r_asm_free
r_asm_free.restype = None
r_asm_free.argtypes = [POINTER_T(struct_r_asm_t)]
r_asm_modify = _libr_asm.r_asm_modify
r_asm_modify.restype = ctypes.c_bool
r_asm_modify.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_ubyte), ctypes.c_int32, ctypes.c_uint64]
r_asm_mnemonics = _libr_asm.r_asm_mnemonics
r_asm_mnemonics.restype = POINTER_T(ctypes.c_char)
r_asm_mnemonics.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_int32, ctypes.c_bool]
r_asm_mnemonics_byname = _libr_asm.r_asm_mnemonics_byname
r_asm_mnemonics_byname.restype = ctypes.c_int32
r_asm_mnemonics_byname.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_set_user_ptr = _libr_asm.r_asm_set_user_ptr
r_asm_set_user_ptr.restype = None
r_asm_set_user_ptr.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(None)]
r_asm_add = _libr_asm.r_asm_add
r_asm_add.restype = ctypes.c_bool
r_asm_add.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(struct_r_asm_plugin_t)]
r_asm_setup = _libr_asm.r_asm_setup
r_asm_setup.restype = ctypes.c_bool
r_asm_setup.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char), ctypes.c_int32, ctypes.c_int32]
r_asm_is_valid = _libr_asm.r_asm_is_valid
r_asm_is_valid.restype = ctypes.c_bool
r_asm_is_valid.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_use = _libr_asm.r_asm_use
r_asm_use.restype = ctypes.c_bool
r_asm_use.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_use_assembler = _libr_asm.r_asm_use_assembler
r_asm_use_assembler.restype = ctypes.c_bool
r_asm_use_assembler.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_set_arch = _libr_asm.r_asm_set_arch
r_asm_set_arch.restype = ctypes.c_bool
r_asm_set_arch.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char), ctypes.c_int32]
r_asm_set_bits = _libr_asm.r_asm_set_bits
r_asm_set_bits.restype = ctypes.c_int32
r_asm_set_bits.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_int32]
r_asm_set_cpu = _libr_asm.r_asm_set_cpu
r_asm_set_cpu.restype = None
r_asm_set_cpu.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_set_big_endian = _libr_asm.r_asm_set_big_endian
r_asm_set_big_endian.restype = ctypes.c_bool
r_asm_set_big_endian.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_bool]
r_asm_set_syntax = _libr_asm.r_asm_set_syntax
r_asm_set_syntax.restype = ctypes.c_bool
r_asm_set_syntax.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_int32]
r_asm_syntax_from_string = _libr_asm.r_asm_syntax_from_string
r_asm_syntax_from_string.restype = ctypes.c_int32
r_asm_syntax_from_string.argtypes = [POINTER_T(ctypes.c_char)]
r_asm_set_pc = _libr_asm.r_asm_set_pc
r_asm_set_pc.restype = ctypes.c_int32
r_asm_set_pc.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_uint64]
r_asm_disassemble = _libr_asm.r_asm_disassemble
r_asm_disassemble.restype = ctypes.c_int32
r_asm_disassemble.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(struct_r_asm_op_t), POINTER_T(ctypes.c_ubyte), ctypes.c_int32]
r_asm_assemble = _libr_asm.r_asm_assemble
r_asm_assemble.restype = ctypes.c_int32
r_asm_assemble.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(struct_r_asm_op_t), POINTER_T(ctypes.c_char)]
r_asm_mdisassemble = _libr_asm.r_asm_mdisassemble
r_asm_mdisassemble.restype = POINTER_T(struct_r_asm_code_t)
r_asm_mdisassemble.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_ubyte), ctypes.c_int32]
r_asm_mdisassemble_hexstr = _libr_asm.r_asm_mdisassemble_hexstr
r_asm_mdisassemble_hexstr.restype = POINTER_T(struct_r_asm_code_t)
r_asm_mdisassemble_hexstr.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(struct_r_parse_t), POINTER_T(ctypes.c_char)]
r_asm_massemble = _libr_asm.r_asm_massemble
r_asm_massemble.restype = POINTER_T(struct_r_asm_code_t)
r_asm_massemble.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_rasm_assemble = _libr_asm.r_asm_rasm_assemble
r_asm_rasm_assemble.restype = POINTER_T(struct_r_asm_code_t)
r_asm_rasm_assemble.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char), ctypes.c_bool]
r_asm_to_string = _libr_asm.r_asm_to_string
r_asm_to_string.restype = POINTER_T(ctypes.c_char)
r_asm_to_string.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_uint64, POINTER_T(ctypes.c_ubyte), ctypes.c_int32]
r_asm_from_string = _libr_asm.r_asm_from_string
r_asm_from_string.restype = POINTER_T(ctypes.c_ubyte)
r_asm_from_string.argtypes = [POINTER_T(struct_r_asm_t), ctypes.c_uint64, POINTER_T(ctypes.c_char), POINTER_T(ctypes.c_int32)]
r_asm_filter_input = _libr_asm.r_asm_filter_input
r_asm_filter_input.restype = ctypes.c_int32
r_asm_filter_input.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_filter_output = _libr_asm.r_asm_filter_output
r_asm_filter_output.restype = ctypes.c_int32
r_asm_filter_output.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_describe = _libr_asm.r_asm_describe
r_asm_describe.restype = POINTER_T(ctypes.c_char)
r_asm_describe.argtypes = [POINTER_T(struct_r_asm_t), POINTER_T(ctypes.c_char)]
r_asm_get_plugins = _libr_asm.r_asm_get_plugins
r_asm_get_plugins.restype = POINTER_T(struct_r_list_t)
r_asm_get_plugins.argtypes = [POINTER_T(struct_r_asm_t)]
...
r_asm_code_new.restype = POINTER_T(struct_r_asm_code_t)
r_asm_code_new.argtypes = []
r_asm_code_free = _libr_asm.r_asm_code_free
r_asm_code_free.restype = POINTER_T(None)
r_asm_code_free.argtypes = [POINTER_T(struct_r_asm_code_t)]
r_asm_equ_item_free = _libr_asm.r_asm_equ_item_free
r_asm_equ_item_free.restype = None
r_asm_equ_item_free.argtypes = [POINTER_T(struct_c__SA_RAsmEqu)]
r_asm_code_set_equ = _libr_asm.r_asm_code_set_equ
r_asm_code_set_equ.restype = ctypes.c_bool
r_asm_code_set_equ.argtypes = [POINTER_T(struct_r_asm_code_t), POINTER_T(ctypes.c_char), POINTER_T(ctypes.c_char)]
r_asm_code_equ_replace = _libr_asm.r_asm_code_equ_replace
r_asm_code_equ_replace.restype = POINTER_T(ctypes.c_char)
r_asm_code_equ_replace.argtypes = [POINTER_T(struct_r_asm_code_t), POINTER_T(ctypes.c_char)]
r_asm_code_get_hex = _libr_asm.r_asm_code_get_hex
r_asm_code_get_hex.restype = POINTER_T(ctypes.c_char)
r_asm_code_get_hex.argtypes = [POINTER_T(struct_r_asm_code_t)]
r_asm_op_new = _libr_asm.r_asm_op_new
r_asm_op_new.restype = POINTER_T(struct_r_asm_op_t)
r_asm_op_new.argtypes = []
r_asm_op_init = _libr_asm.r_asm_op_init
r_asm_op_init.restype = None
r_asm_op_init.argtypes = [POINTER_T(struct_r_asm_op_t)]
r_asm_op_free = _libr_asm.r_asm_op_free
r_asm_op_free.restype = None
r_asm_op_free.argtypes = [POINTER_T(struct_r_asm_op_t)]
r_asm_op_fini = _libr_asm.r_asm_op_fini
r_asm_op_fini.restype = None
r_asm_op_fini.argtypes = [POINTER_T(struct_r_asm_op_t)]
r_asm_op_get_hex = _libr_asm.r_asm_op_get_hex
r_asm_op_get_hex.restype = POINTER_T(ctypes.c_char)
r_asm_op_get_hex.argtypes = [POINTER_T(struct_r_asm_op_t)]
r_asm_op_get_asm = _libr_asm.r_asm_op_get_asm
r_asm_op_get_asm.restype = POINTER_T(ctypes.c_char)
r_asm_op_get_asm.argtypes = [POINTER_T(struct_r_asm_op_t)]
r_asm_op_get_size = _libr_asm.r_asm_op_get_size
r_asm_op_get_size.restype = ctypes.c_int32
r_asm_op_get_size.argtypes = [POINTER_T(struct_r_asm_op_t)]
r_asm_op_set_asm = _libr_asm.r_asm_op_set_asm
r_asm_op_set_asm.restype = None
r_asm_op_set_asm.argtypes = [POINTER_T(struct_r_asm_op_t), POINTER_T(ctypes.c_char)]
r_asm_op_set_hex = _libr_asm.r_asm_op_set_hex
r_asm_op_set_hex.restype = ctypes.c_int32
r_asm_op_set_hex.argtypes = [POINTER_T(struct_r_asm_op_t), POINTER_T(ctypes.c_char)]
r_asm_op_set_hexbuf = _libr_asm.r_asm_op_set_hexbuf
r_asm_op_set_hexbuf.restype = ctypes.c_int32
r_asm_op_set_hexbuf.argtypes = [POINTER_T(struct_r_asm_op_t), POINTER_T(ctypes.c_ubyte), ctypes.c_int32]
r_asm_op_set_buf = _libr_asm.r_asm_op_set_buf
r_asm_op_set_buf.restype = None
r_asm_op_set_buf.argtypes = [POINTER_T(struct_r_asm_op_t), POINTER_T(ctypes.c_ubyte), ctypes.c_int32]
r_asm_op_get_buf = _libr_asm.r_asm_op_get_buf
r_asm_op_get_buf.restype = POINTER_T(ctypes.c_ubyte)
r_asm_op_get_buf.argtypes = [POINTER_T(struct_r_asm_op_t)]
...
r_asm_plugin_spc700 = struct_r_asm_plugin_t # Variable struct_r_asm_plugin_t
...
__all__ = \
    ...
    'R_ASM_SYNTAX_REGNUM', '__ptrace_request', 'c__EA_RAnalCPPABI',
    ...
    'r_asm_disassemble', 'r_asm_equ_item_free', 'r_asm_filter_input',
    'r_asm_filter_output', 'r_asm_free', 'r_asm_from_string',
    ...
    'r_asm_plugin_m68k_cs', 'r_asm_plugin_malbolge',
    ...
    'r_asm_plugin_or1k', 'r_asm_plugin_pic', 'r_asm_plugin_ppc_cs',
    ...
    'r_asm_plugin_spc700', 'r_asm_plugin_sysz', 'r_asm_plugin_tms320',
    'r_asm_plugin_tms320c64x', 'r_asm_plugin_tricore',
    'r_asm_plugin_v810', 'r_asm_plugin_v850', 'r_asm_plugin_vax',
    ...
    'r_asm_setup', 'r_asm_syntax_from_string', 'r_asm_to_string',
    'r_asm_use', 'r_asm_use_assembler', 'r_asm_version',
    ...
    'struct_r_anal_value_t', 'struct_r_asm_code_t',
